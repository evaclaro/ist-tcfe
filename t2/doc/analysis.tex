...
\includegraphics[width=0.6\linewidth]{../mat/natural.eps}
...
\begin{figure}[h] \centering
\includegraphics[width=0.6\linewidth]{../mat/theorical_5.eps}
\caption{C Mesh with an adicional voltage source} %mudar legendaaaaaaa
\label{fig:mat4}
\end{figure}
...
\begin{figure}[h] \centering
\includegraphics[width=0.6\linewidth]{../mat/Phase.eps}
\caption{C Mesh with an adicional voltage source} %mudar legendaaaaaaa
\label{fig:mat5db}
\end{figure}

\begin{figure}[h] \centering
\includegraphics[width=0.6\linewidth]{../mat/MagnitudedB.eps}
\caption{C Mesh with an adicional voltage source} %mudar legendaaaaaaa
\label{fig:mat5ps}
\end{figure}
